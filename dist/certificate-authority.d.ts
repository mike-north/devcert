 ...
 * per-app certs.
 */
export default function installCertificateAuthority(options: Options | undefined, certOptions: CertOptions): Promise<void>;
 ...
 */
export declare function ensureCACertReadable(options: Options, certOptions: CertOptions): Promise<void>;
/**
